...
public class Vinho {
	...
	@Id
	@SequenceGenerator(name = "vinho_seq", sequenceName = "vinho_seq", initialValue = 1)
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "vinho_seq")
	private Long codigo;
	...
	public String toString() {
		return "Vinho [codigo=" + codigo + ", nome=" + nome + ", tipo=" + tipo + ", safra=" + safra + ", volume="
				+ volume + ", valor=" + valor + ", foto=" + foto + ", url=" + url + "]";
	}
