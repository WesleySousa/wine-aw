...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private final static String CADASTRAR_VINHO = "CADASTRAR_VINHO";
	private final static String LISTAR_VINHO = "LISTAR_VINHO";
	...
	protected void configure(HttpSecurity http) throws Exception {
		// Qualquer requisição tem que estar autenticado.
		http
			.authorizeRequests()
